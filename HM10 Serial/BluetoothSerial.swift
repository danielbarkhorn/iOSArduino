...
//MARK: functions
    ...
    init(delegate: BluetoothSerialDelegate) {
        ...
        // Central Manager is used to discover the peripherals, as well as connect / disconnect from them
    ...
    func sendMessageToDevice(_ message: String) {
        ...
        {
            print("DID NOT SUCCESSFULLY SEND")
        }
    }
...
//    func sendIntToDevice(_ num: Int)
//    {
//        guard isReady else { return }
//        
//        connectedPeripheral!.writeValue(<#T##data: Data##Data#>, for: <#T##CBCharacteristic#>, type: <#T##CBCharacteristicWriteType#>)
//    }
...
//MARK: CBPeripheralDelegate functions
    ...
    func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic, error: Error?) {
        ...
        // first the data
        // Their custom made data structure
            //delegate.serialDidReceiveData(data!)
        
        // then the string
        // What we will use most likely, unless we want to use bytes? (stick with this for now)
